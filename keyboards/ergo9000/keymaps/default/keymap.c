...
[_BASE] = LAYOUT(
    ...
    FLIP_TABLE, KC_CUT,   KC_COPY,   KC_HYPR,  KC_A,    KC_S,    KC_D,    KC_F,    KC_G,          KC_H,    KC_J,    KC_K,    KC_L,    KC_SCLN, KC_QUOT, KC_ENT,  XXXXXXX,  KC_HOME,
    SRSLY,   KC_PASTE, KC_UNDO,   KC_LSFT,  KC_Z,    KC_X,    KC_C,    KC_V,    KC_B,          KC_N,    KC_M,    KC_COMM, KC_DOT,  KC_SLSH, KC_RSFT, KC_PGUP, KC_UP,    KC_PGDN,
    SHRUG,   KC_FIND,  KC_SELECT, KC_LCTL,  KC_LALT, KC_LGUI, KC_DEL,  KC_SPC,  TL_LOWR,         TL_UPPR, KC_SPC,  KC_BSPC, KC_RGUI, KC_RALT, KC_RCTL, KC_LEFT, KC_DOWN,  KC_RGHT
),
[_LOWER] = LAYOUT(
    _______, _______,  _______,   _______,  _______, _______, _______, _______, _______,       KC_MUTE, KC_VOLD, KC_VOLU, _______, _______, _______, _______, _______,  _______,
    _______, _______,  _______,   _______,  _______, _______, _______, _______, _______,       _______, _______, KC_PSLS, KC_PAST, KC_PMNS, _______, _______, _______,  XXXXXXX,
    _______, _______,  XXXXXXX,   _______,  _______, _______, _______, _______, _______,       _______, KC_KP_7, KC_KP_8, KC_KP_9, KC_PPLS, _______, _______, _______,  KC_INS,
    _______, _______,  _______,   _______,  KC_LSFT, KC_LCTL, KC_LALT, KC_LGUI, _______,       _______, KC_KP_4, KC_KP_5, KC_KP_6, KC_PPLS, _______, _______, XXXXXXX,  KC_END,
    _______, _______,  _______,   _______,  MS_ACL0, MS_ACL1, MS_ACL2, _______, _______,       _______, KC_KP_1, KC_KP_2, KC_KP_3, KC_PENT, MS_WHLU, MS_BTN1, MS_UP,    MS_BTN2,
    _______, _______,  _______,   _______,  _______, _______, _______, _______, _______,       _______, _______, KC_KP_0, KC_PDOT, KC_PENT, MS_WHLD, MS_LEFT, MS_DOWN,  MS_RGHT
),
[_RAISE] = LAYOUT(
